...
# Fonction pour la mise en miroir synchrone
def synchronous_mirror(data):
    # Simulation d'un délai pour la communication synchrone
    time.sleep(0.1)  # À adapter en fonction des besoins de latence
    
    # Écriture des données sur le système de stockage miroir
    # Ici, nous supposons une opération réussie sans gestion d'erreur pour la simplicité de l'exemple
    # Dans un environnement réel, la gestion d'erreurs devrait être incluse
    with open('mirrored_products.json', 'w', encoding='utf-8') as file:
